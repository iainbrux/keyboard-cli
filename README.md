...
stdout before it opens the device at all. The key matrix on the right needs a 168-column
terminal to draw a 68-key board (112 columns for the widest key row, plus the 56-column settings
