export enum OrderType {
  ...
  ORDER_TYPE_CURRENT_AXOSOME = 0x75, // 当前键盘的轴体，s_arg = [uint16,uint]
  ORDER_TYPE_AXOSOME = 0x76, // 查询键盘支持的轴体ID
  QUERY_LIGHT_FIX_RGB = 0x44,
  ORDER_TYPE_RGBNACK = 0x47, // 自定义灯光是否有回包
}
...
export enum KeyLayout {
  ...
  Layout_RTP = 0x14,
  Layout_RTR = 0x15,
  Layout_DP = 0x16, // 单键死区按下
  Layout_DR = 0x17, // 单键死区抬起
  Layout_KR = 0x18, // 单键释放
  Layout_AXIS = 0x19, // 轴体切换层
  Layout_RS = 0x20, // rs
}
